...
#
# @subsection <Master Task> (Master Task)
...
# 
# @subsection <Pitch Task> (Pitch Task)
...
#
# @subsection <Camera Task> (Camera Task)
...
# screen.
# 
# @subsection <Firing Task> (Firing Task)
